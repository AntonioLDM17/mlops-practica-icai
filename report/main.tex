...
\texttt{Note:}
** Also remember that this project is on top of the MLOps project, so go to the repo (https://github.com/AntonioLDM17/mlops-practica-icai) and see the README.md to learn how to execute the code and be able to see it deployed on your browser **
\end{document}
